    ...
    static void Main(string[] args)
    {
     ...
     // Console.WriteLine("Please provide your input");
      ...
      Debug.WriteLine("Doubling time is " + doublingTime + " years");
            ...
            Console.WriteLine("Please input value for side a, b, and c (hit ENTR after each)");
            string userInputToCheckx = Console.ReadLine();
            string userInputToChecky = Console.ReadLine();
            string userInputToCheckz = Console.ReadLine();
            ...
            try
            {
                x = Convert.ToDouble(userInputToCheckx);
                y = Convert.ToDouble(userInputToChecky);
                z = Convert.ToDouble(userInputToCheckz);
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
